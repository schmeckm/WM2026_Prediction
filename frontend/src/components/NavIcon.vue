...
const markup = {
  ...
  bracket: svg('<path d="M4 5h4v3H4z"/><path d="M16 5h4v3h-4z"/><path d="M4 16h4v3H4z"/><path d="M16 16h4v3h-4z"/><path d="M8 6.5h8"/><path d="M8 17.5h8"/><path d="M12 6.5V10"/><path d="M12 14v3.5"/>'),
  ...
  compress: svg('<path d="M8 3v3a2 2 0 0 1-2 2H3"/><path d="M21 8h-3a2 2 0 0 1-2-2V3"/><path d="M3 16h3a2 2 0 0 1 2 2v3"/><path d="M16 21v-3a2 2 0 0 1 2-2h3"/>'),
};
</script>
